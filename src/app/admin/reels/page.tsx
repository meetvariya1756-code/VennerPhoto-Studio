  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-serif text-[#1A1A1A] font-medium tracking-wide">Video Reels</h1>
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white border border-neutral-200 rounded-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto shadow-2xl">
            <div className="flex items-center justify-between p-6 border-b border-neutral-200">
              <h2 className="text-[#1A1A1A] font-semibold">{editing.id ? 'Edit' : 'New'} Reel</h2>
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <label htmlFor="r-feat" className="text-sm text-neutral-600">Featured reel (shown on homepage)</label>
              </div>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button type="button" onClick={() => setEditing(null)} className="text-neutral-500 hover:text-neutral-700 border border-neutral-300 hover:bg-neutral-50 px-6 py-2.5 rounded-lg text-sm transition-colors shadow-sm font-medium">Cancel</button>
              </div>
            </form>
          </div>
        </div>
